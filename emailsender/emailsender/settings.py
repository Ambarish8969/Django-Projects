...
SECRET_KEY = 'django-insecure-k)c__lqpt*#yxej0j)xkf=6^y13p8cyqcb9_6ys2c)9h=33ag2'
...
EMAIL_HOST = 'smtp.gmail.com'  # Update this with your SMTP server's address
EMAIL_PORT = 587  # Update this with your SMTP server's port number
EMAIL_USE_TLS = True  # Use TLS for secure communication (or use EMAIL_USE_SSL if applicable)
EMAIL_USE_SSL = False
